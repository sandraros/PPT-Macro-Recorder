...
Function New_MR_Diff(ObjectName As String, StopObject As Object, StartObject As Object) As MR_Diff

    On Error GoTo err_

    Set New_MR_Diff = New MR_Diff
    New_MR_Diff.ObjectName = ObjectName
    Set New_MR_Diff.StartObject = StartObject
    Set New_MR_Diff.StopObject = StopObject
